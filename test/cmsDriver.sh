...
foreach gtag ( STARTUP MC )
  ...
  echo "Creating TTbarGenSim $gtag"
    cmsDriver.py TTbar_Tauola_7TeV_cfi --step=GEN,SIM                        --conditions=$GTAG                                                                        --fileout=TTbarGenSim_$gtag.root         --number=100 --mc --no_exec --datatier 'GEN-SIM'              --eventcontent=FEVTSIM      --customise=HLTrigger/Configuration/CustomConfigs.Base    --python_filename=TTbarGenSim_$gtag.py
