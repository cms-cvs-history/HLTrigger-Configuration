...
#   cmsDriver.py RelVal           --step=RAW2DIGI,L1Reco,RECO           --conditions=$GTAG --filein=file:RelVal_DigiL1Raw_$name.root    --custom_conditions=$XL1T --fileout=RelVal_RECO_$name.root         --number=100 --mc --no_exec --datatier 'RECO'                 --eventcontent=RECOSIM      --customise=HLTrigger/Configuration/custom_Options.py         --python_filename=RelVal_RECO_$name.py
