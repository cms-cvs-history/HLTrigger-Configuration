...
MASTER="/dev/CMSSW_3_2_7/highrate/HLT"          # no explicit version, take te most recent 
TARGET="/dev/CMSSW_3_2_7/highrate/\$TABLE"      # no explicit version, take te most recent 
TABLES="8E29 GRun"                              # $TABLE in the above variable will be expanded to these TABLES
